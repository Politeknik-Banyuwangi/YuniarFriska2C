...
@section('content')
    <div class="container mx-auto px-4 pt-16">
        ...
        <div class="popular-movie">
            <h2 class="capitalize text-white text-lg font-bold">Popular Movie</h2>
        ...
        <!-- Playing Now -->
        <div class="popular-movie">
            <h2 class="capitalize text-white text-lg font-bold">Playing NOW</h2>
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-8 gap-3">
        ...
        <div class="popular-movie pb-10">
            <h2 class="capitalize text-white text-lg font-bold">Upcoming Movie</h2>
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-8 gap-3">
